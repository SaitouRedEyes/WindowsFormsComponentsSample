...
namespace ClientServerCalculatorV2
{
    class Http
    {
        ...
        {
            SOMA = 1, MULT = 2, LOG = 3, SUB = 4, DIV = 5, POW = 6
        }
        ...
        public string SendToServer(Dictionary<string, string> parameters)
        {
            ...
            try
            {
                ...
                HttpWebRequest myHttpWebRequest = (HttpWebRequest)WebRequest.Create("http://localhost/php_mysql_samples/4oBi_av2_requests_calculator.php");
